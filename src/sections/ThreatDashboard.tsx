  ...
  return (
    <div ref={ref} className="space-y-2.5">
      <div className="flex justify-between items-baseline">
        <span className="text-[11px] tracking-[0.1em] text-[#5a5550] font-mono">{label}</span>
  ...
  return (
    <section className="py-28 md:py-40 px-6">
      <div className="max-w-4xl mx-auto">
        ...
        >
          <p className="text-[10px] tracking-[0.5em] text-[#8b6914] font-mono mb-4">THREAT ASSESSMENT</p>
          <h2 className="text-3xl md:text-5xl font-display text-[#f5e6c8] glow-text-strong">Subject Analysis</h2>
        ...
        <div
          ref={stats.ref}
          className="grid grid-cols-3 gap-4 md:gap-5 mb-8"
        ...
        >
          {[
            ...
            { label: "SALUTES THIS MONTH", value: 142 },
            { label: "WALLS LEANED ON", value: 891, suffix: "+" },
          ].map((s, i) => (
            <div
              key={i}
              className="card-3d p-5 md:p-7 bg-[#0c0b0a] border border-[#ffffff08] rounded-xl text-center"
              style={{
                opacity: stats.v ? 1 : 0,
            ...
            >
              <div className="text-2xl md:text-4xl font-mono text-[#f5e6c8] glow-text mb-3">
                <Counter end={s.value} suffix={s.suffix} />
              </div>
              <div className="text-[9px] tracking-[0.15em] text-[#5a5550] font-mono">{s.label}</div>
            </div>
          ))}
        </div>
        ...
        <div
          ref={meters.ref}
          className="bg-[#0c0b0a] border border-[#ffffff08] rounded-xl p-7 md:p-9 space-y-5"
        ...
        >
          <p className="text-[9px] tracking-[0.3em] text-[#3a3530] font-mono text-center mb-6">BEHAVIORAL ANALYSIS MATRIX</p>
          {[
        ...
        <div className="mt-12 flex justify-center">
          <div className="border border-[#8b000044] rounded px-5 py-1.5 rotate-[-2deg]">
            <span className="text-[#8b0000] text-[10px] tracking-[0.25em] font-mono">TOP SECRET // BPI EYES ONLY</span>
          </div>
        </div>
      </div>
    </section>
