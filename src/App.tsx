...
function Divider() {
  return <div className="hr-glow mx-8 md:mx-20 lg:mx-40" />;
}
    ...
    <>
      ...
      <div style={{ opacity: loaded ? 1 : 0, transition: "opacity 0.6s ease 0.2s" }}>
        ...
        <div className="relative z-10">
          {/* Nav — no backdrop-blur, solid bg instead */}
          <nav className="fixed top-0 left-0 right-0 z-50 px-6 md:px-10 py-4 flex items-center justify-between bg-[#050505]/90 border-b border-[#ffffff06]">
            <div className="flex items-center gap-2.5">
              <span className="text-sm">🥔</span>
              <span className="text-[9px] tracking-[0.25em] text-[#8b6914] font-mono">BPI CASE FILE</span>
            </div>
            ...
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-[8px] tracking-[0.15em] text-[#8b0000] font-mono">LIVE</span>
            </div>
          </nav>

          {/* Hero spacer — transparent, 3D shows through */}
          <section className="h-screen flex items-end justify-center pb-12 pointer-events-none">
            <div className="flex flex-col items-center gap-2 opacity-40">
              <span className="text-[9px] tracking-[0.35em] uppercase text-[#8b6914] font-mono">
                Scroll to investigate
              </span>
              <div className="w-[1px] h-6 bg-gradient-to-b from-[#d4a843] to-transparent animate-pulse" />
            </div>
          </section>

          {/* Content — solid dark bg, no blur. Gaps let 3D peek through */}
          ...
          <div className="bg-[#050505]">
            <Divider />
            <LegendSection />
            <footer className="py-10 text-center border-t border-[#ffffff06]">
              <p className="text-[8px] tracking-[0.35em] text-[#2a2520] font-mono leading-loose">
